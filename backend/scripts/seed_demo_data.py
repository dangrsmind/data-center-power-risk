...
def seed_projects(db: Session, regions: dict[str, Region], utilities: dict[str, Utility]) -> list[Project]:
    ...
    create_evidence_claim(
        ...
        claim_type=ClaimType.EVENT_SUPPORT_E3.value,
        claim_value_json={
            "summary": "Demo ERCOT large-load screening guidance",
            "reason_class": "large_load_screening_update",
        },
    ...
    for spec in PROJECTS:
        ...
        create_evidence_claim(
            ...
            claim_type=ClaimType.PROJECT_NAME_MENTION.value,
            claim_value_json={
                "project_name": spec.canonical_name,
            },
        ...
        for phase_spec in spec.phases:
            ...
            create_evidence_claim(
                ...
                entity_type="phase",
                entity_id=phase.id,
                claim_type=ClaimType.MODELED_LOAD_MW.value,
                claim_value_json={
        ...
        if spec.event_family and first_phase:
            ...
            create_evidence_claim(
                ...
                claim_type=(
                    ClaimType.EVENT_SUPPORT_E2.value
                    if spec.event_family == EventFamily.E2
                    else ClaimType.EVENT_SUPPORT_E4.value
                ),
                claim_value_json={
                    "summary": spec.event_notes,
                    "reason_class": spec.reason_class,
                },
