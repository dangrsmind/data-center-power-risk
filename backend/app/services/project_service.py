...
class ProjectService:
    ...
    def list_projects(self) -> list[ProjectListItem]:
        ...
        return [
            ProjectListItem(
                ...
                coordinate_status=row.project.coordinate_status,
                coordinate_precision=row.project.coordinate_precision,
                coordinate_source=row.project.coordinate_source,
                coordinate_source_url=row.project.coordinate_source_url,
                coordinate_notes=row.project.coordinate_notes,
                coordinate_confidence=row.project.coordinate_confidence,
                coordinate_updated_at=row.project.coordinate_updated_at,
                coordinate_verified_at=row.project.coordinate_verified_at,
    ...
    def get_project(self, project_id: uuid.UUID) -> ProjectDetail:
        ...
        return ProjectDetail(
            ...
            coordinate_status=project.coordinate_status,
            coordinate_precision=project.coordinate_precision,
            coordinate_source=project.coordinate_source,
            coordinate_source_url=project.coordinate_source_url,
            coordinate_notes=project.coordinate_notes,
            coordinate_confidence=project.coordinate_confidence,
            coordinate_updated_at=project.coordinate_updated_at,
            coordinate_verified_at=project.coordinate_verified_at,
